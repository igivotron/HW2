...
\begin{figure}
    ...
    \caption{T-S Diagram of Turbojet with After-Burner at M=0.8}
    \label{fig:TSdiagram}
\end{figure}
...
At lower Mach number (M=0.8), the temperature increases a lot in the combustion chamber, as well as the entropy while at M=2.44, the temperature increase is more moderate. This is due to the fact that at higher Mach number, the air entering the combustor is already at a higher temperature due to the ram effect and the compressor, so less fuel is needed to reach the same turbine inlet temperature.\\
\color{red} TODO: Add more analysis \color{black}
